          ...
          <motion.div variants={itemVariants} className="space-y-8 mt-12">
            ...
            {votingActive && liveVotingActive ? (
              ...
              <Button
                asChild
                size="lg"
                className="bg-gradient-to-r from-yellow-500 via-yellow-400 to-amber-500 hover:from-yellow-400 hover:via-yellow-300 hover:to-amber-400 text-black px-12 py-6 text-lg font-semibold rounded-full shadow-[0_0_30px_rgba(234,179,8,0.4)] hover:shadow-[0_0_40px_rgba(234,179,8,0.6)] transition-all duration-300 transform hover:scale-105 font-body border-0"
              >
                <Link href="/winner">
                  <Vote className="mr-3 h-6 w-6" />
                  View Winners
